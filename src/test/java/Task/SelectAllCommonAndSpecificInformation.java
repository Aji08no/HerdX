...
public class SelectAllCommonAndSpecificInformation extends Herd {
    WebDriverWait wait;
...
//                wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@content-desc='Treatment']//*[@class='android.widget.ImageView']"))).click();
        ...
        //secondary id
        WebElement enterSecdaryId1 = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//android.widget.EditText[@index='2']")));
        enterSecdaryId1.click();
        enterSecdaryId1.sendKeys("02");
        driver.hideKeyboard();

        //usda tag
        WebElement enterUsdaTag1 = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//android.widget.EditText[@index='3']")));
        enterUsdaTag1.click();
        enterUsdaTag1.sendKeys("840785869236584");
        driver.hideKeyboard();
        ...
        enterWeaningWeight1.sendKeys("404");
        driver.hideKeyboard();
        ...
        toEnter.click();
        Thread.sleep(100);
        toEnter.sendKeys("2811");
        //view summary
        wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@content-desc='View Summary']"))).click();

        //add info
        wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[contains(@content-desc,'2810')]//*[contains(@content-desc,'Add Info')]"))).click();
        ...
        enterUsdaTag2.click();
        enterUsdaTag2.sendKeys("840785869236584");
        driver.hideKeyboard();
        ...
        //weaning weight
        WebElement enterWeaningWeight2 = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//android.widget.EditText[@index='6']")));
        enterWeaningWeight2.click();
        enterWeaningWeight2.sendKeys("404");
        driver.hideKeyboard();
        ...
        //add info
        wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[contains(@content-desc,'2811')]//*[contains(@content-desc,'Add Info')]"))).click();
        ...
        enterUsdaTag3.click();
        enterUsdaTag3.sendKeys("840785869236584");
        driver.hideKeyboard();
        ...
        //weaning weight
        WebElement enterWeaningWeight3 = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//android.widget.EditText[@index='6']")));
        enterWeaningWeight3.click();
        enterWeaningWeight3.sendKeys("404");
        driver.hideKeyboard();
...
//        Thread.sleep(2000);
    ...
    public void verifyAddTagId() throws InterruptedException {
//        WebElement totalAnimals = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("(//*[@class='android.widget.ImageView'])[5]")));
//        //driver.findElement(By.xpath("(//*[@class='android.widget.ImageView'])[5]")).click();
//        totalAnimals.click();
//        Thread.sleep(3000);
        ...
        //scroll
        Thread.sleep(1000);
        touchAction.press(PointOption.point(541,2025))
                .waitAction(WaitOptions.waitOptions(Duration.ofSeconds(3)))
                .moveTo(PointOption.point(541,690))
                .release()
                .perform();
        ...
        wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("(//android.widget.ImageView[@index='0'])[1]"))).click();
        //2805
        wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[contains(@content-desc,'2805')]"))).click();
        //scroll
        Thread.sleep(1000);
        touchAction.press(PointOption.point(541,2025))
                .waitAction(WaitOptions.waitOptions(Duration.ofSeconds(3)))
        ...
        wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("(//android.widget.ImageView[@index='0'])[1]"))).click();
        //2810
        wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[contains(@content-desc,'2810')]"))).click();
        //scroll
        Thread.sleep(1000);
        touchAction.press(PointOption.point(541,2025))
                .waitAction(WaitOptions.waitOptions(Duration.ofSeconds(3)))
        ...
        wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("(//android.widget.ImageView[@index='0'])[1]"))).click();
        //scroll
        touchAction.press(PointOption.point(541,1966))
                .waitAction(WaitOptions.waitOptions(Duration.ofSeconds(3)))
                .moveTo(PointOption.point(523,397))
                .release()
                .perform();
        //2811
        wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[contains(@content-desc,'2811')]"))).click();
        //scroll
        Thread.sleep(1000);
        touchAction.press(PointOption.point(541,2025))
                .waitAction(WaitOptions.waitOptions(Duration.ofSeconds(3)))
